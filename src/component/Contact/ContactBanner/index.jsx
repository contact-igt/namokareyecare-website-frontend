...
export default function ContactBanner() {
  const { eyebrow, title, description, cta, secondaryCta, stats } = contactContent.banner;

  return (
    <section className={styles.hero} aria-label="Contact Namokar Eye and Oculoplasty Centre">
