...
export default function ReconstructiveTreatmentApproach() {
  const { treatmentApproach } = reconstructiveContent;
  const {
    eyebrow,
    titleLine1,
    titleLine2,
      ...
      <div className={styles.container}>
        ...
        <RevealOnView variant="fadeUp">
          <div className={styles.header}>
            ...
            <h2 id="treatment-approach-title" className={styles.heading}>
